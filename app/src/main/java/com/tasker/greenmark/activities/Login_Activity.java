package com.tasker.greenmark.activities;
...
import com.tasker.greenmark.R;
import com.tasker.greenmark.others.SharedPref;

import java.util.Objects;

public class Login_Activity extends AppCompatActivity {
    private EditText editText,editText1, editTest3;
                ...
                if(motionEvent.getAction() == MotionEvent.ACTION_UP) {
                    if((motionEvent.getRawX() >= (editText.getRight() - editText.getCompoundDrawables()[2].getBounds().width() - 20))) {
                        if(editText.getText().length() <= 0) {
                            ...
                            db.collection("Employees").document().get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
